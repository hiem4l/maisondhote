...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Maison d'hôtes de charme en Provence. Chambres d'exception, piscine, gastronomie locale."}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"La Bastide des Oliviers — Maison d'Hôtes"};
